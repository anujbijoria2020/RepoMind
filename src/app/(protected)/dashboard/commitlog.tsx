  ...
  return (
   ...
   <ul className="space-y-6">
    ...
    return <li key={commit.id} className="relative flex gap-x-4">
      <div className={
        cn(commitIdx===commits.length-1 ? 'h-6':'bottom-6','absolute left-0 top-0 flex w-6 justify-center')
      }>
      ...
      <div className="flex-auto rounded-mg bg-white p-3 ring-1 ring-inset ring-gray-200">
        <div className="flex justify-between gap-x-4">
          <Link href={`${project?.githubUrl}/commit/${commit.commitHash}`} className="py-0.5 text-gray-500 text-xs leading-5 flex gap-1">
